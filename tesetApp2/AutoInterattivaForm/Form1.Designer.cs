namespace AutoInterattivaForm
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            radialGauge1.BackgroundGradientStartColor = Color.Blue;
            radialGauge1.EnableCustomNeedles = false;
            radialGauge1.FillColor = Color.White;
            radialGauge1.ForeColor = Color.White;
            radialGauge1.FrameThickness = 12;
            radialGauge1.GaugeArcColor = Color.White;
            ...
            radialGauge1.InnerFrameGradientEndColor = Color.Navy;
            radialGauge1.InnerFrameGradientStartColor = Color.Navy;
            radialGauge1.InterLinesColor = Color.White;
            radialGauge1.Location = new Point(515, 110);
            radialGauge1.MajorDifference = 50F;
            radialGauge1.MajorTickMarkColor = Color.Transparent;
            ...
            radialGauge1.OuterFrameGradientEndColor = Color.Black;
            radialGauge1.OuterFrameGradientStartColor = Color.Navy;
            radialGauge1.ScaleLabelColor = Color.White;
